                    ...
                    <div className='process-list'>
                        {
                            process_list.map((item)=>(
                                <div className={`process-card container ${activeId == item.id? 'active': ''}` }
                                    onClick={()=>
                                    ...
                                    <div className='process-card-content'>
                                        <div style={{display: 'inline-flex', alignItems:'center', gap:'1.25rem'}}>
                                            <h1 className='font-h1'>{item.id}</h1>
                                            <h3 className='font-h3'>{item.process_name}</h3>
                                        </div>
                                        
                                        <div>
                                            {
                                                activeId === (item.id)? (<div className='minus' ></div> ) :(<div className='plus' ></div>)
                                            }
                                        </div>
                                    </div>
                                    <div>{
                                    activeId === (item.id) && 
                                    (<div className={`process-expanded ${activeId == item.id? 'active': ''}`}>
                                                    <hr/>
